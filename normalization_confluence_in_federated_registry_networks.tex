...
(via $\Gamma_j$ or $\phi$) of source normal forms, which agree across the two paths;
...
$\Gamma_j$ to read the local component, the shared normal form would depend on the
